...
-- setting nvim-notify as default
...
-- TODO: more sensible keybindings without alt maybe?

-- Navigation in isert mode
...
-- Wimdow split
vim.keymap.set('n', '<M-s>', '<C-w><C-v>', { desc = 'Horizontak window split' })

-- Window close
vim.keymap.set('n', '<M-c>', '<C-w><C-q>', { desc = 'Close window' })

-- Toggle relative numbers
vim.keymap.set('n', '<leader>tn', '<cmd>set rnu!<CR>', { desc = '[T]oggle Relative [N]umbers' })
...
-- vim.keymap.set('n', '<leader>te', '<cmd>ToggleTerm<CR>', { desc = '[T]oggle t[E]rminal' })
-- Navigation between tabs
vim.keymap.set('n', '[t', '<cmd>tabp<CR>', { desc = 'Previous tab' })
vim.keymap.set('n', ']t', '<cmd>tabn<CR>', { desc = 'Next tab' })

-- Keymaps for harpoon: toggling menu, adding file, navigating between files
vim.keymap.set('n', '<leader>to', function()
  vim.cmd [[lua require("harpoon.ui").toggle_quick_menu()]]
end, { desc = '[T]oggle Harp[O]on' })
...
vim.keymap.set('n', '<leader>dr', "<cmd>lua require'dap'.repl.toggle()<CR>", { desc = 'Dap repl open' })
vim.keymap.set(
  'n',
  '<leader>tB',
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- TODO: maybe add keymap to go to hovering buffer
